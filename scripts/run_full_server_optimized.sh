...
export RQ1_FRAGMENT_WORKERS="${RQ1_FRAGMENT_WORKERS:-16}"
...

{
  ...
  echo "Workers: core=${CORE_WORKERS}; core_duration=${CORE_DURATION_WORKERS}; rq1_startup=${RQ1_STARTUP_WORKERS}; rq1_parts=${RQ1_PART_WORKERS}; rq1_boot=${RQ1_BOOT_WORKERS}; rq1_fragments=${RQ1_FRAGMENT_WORKERS}; rq2=${RQ2_WORKERS}; rq3=${RQ3_WORKERS}"
  echo
