...
ms_plot_require_columns(model_manifest,
  c("core_artifact_version", "rq1_analysis_version", "rq2_analysis_version"), "rq2_model_artifact_manifest.csv")
...
conditional <- conditional |>
  mutate(
    ...
    transition_family = factor(if_else(dimension %in% c("placement", "optical"),
...
message("RQ2 v5 figures complete")
